...
void HisEdep(){
   ...
   ROOT::Math::MathMoreLibrary::Load();
	...
	TH1F *hist = new TH1F("hist", "Energ#acute{i}a depositada", 1000, 429 , 432);
	...
	leg->AddEntry(hist, "Energ#acute{i}a depositada", "f"); // l= linea, p= puntos, f= relleno
